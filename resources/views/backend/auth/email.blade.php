            ...
            <div class="row login-first-row">
                ...
                <div class="col-lg-6 col-sm-12 offset-md-1 right-item mx-auto">
                    <a href="{{route('ssoLogin')}}">
                        <img src="{{asset('backend/assets/img/logo_brac.png')}}" class="logo_brac img-fluid">
                    </a>
                    <div class="card">
                            ...
                            <p><span>Reset Password</span></p>
                               ...
                               <form method="POST" action="{{ route('sendEmailForReset') }}">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-right" style="color:#EB078E;">{{ __('E-Mail Address') }}</label>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary" style="background-color:#EB078E;">
